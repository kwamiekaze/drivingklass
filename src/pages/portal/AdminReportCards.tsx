...
function AdminReportCardsContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold theme-heading">All Report Cards</h1>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-lg">{getStudentName(rc.student_id)}</CardTitle>
                  ...
                  <div className="flex items-center gap-3">
                    <Badge className={getRatingColor(rc.overall)}>
                    ...
                    <Link to={`/instructor/report-cards/edit/${rc.id}`}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <p className="text-3xl font-bold">{filteredReportCards.length}</p>
