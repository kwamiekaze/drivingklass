-- Fix the trigger function to use created_at instead of updated_at
...
BEGIN
  ...
  -- Generate dedupe keys (session_id:event_type:user_id:timestamp)
  -- Use NOW() for dedupe since sessions don't have updated_at
